...
const mockDisposalData = {
 ...
 routeOptimizations: [
    // t() is applied to 'routeName', 'depot', and 'details'
    { id: 'R-01', routeName: t("North Zone Daily"), depot: t("Depot 1"), efficiency: "98%", timeSaved: t("+35 min"), confidence: 95, details: t("Optimized path based on real-time bin levels. Recommended vehicles: 2."), routeDetails: 'routeDetails', factors: { fill: 90, traffic: 80, time: 95 } },
    { id: 'R-02', routeName: t("South Zone Weekend"), depot: t("Depot 2"), efficiency: "78%", timeSaved: t("-10 min"), confidence: 60, details: t("Sub-optimal due to unexpected road closures. Manual review needed."), routeDetails: 'routeDetails', factors: { fill: 60, traffic: 70, time: 85 } },
],
